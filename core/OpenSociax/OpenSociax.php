...
tsdefine('APP_LIB_PATH'		, APP_PATH.'/');
tsdefine('APP_ACTION_PATH'	, APP_PATH.'/Action');
tsdefine('APP_MODEL_PATH'	, APP_PATH.'/Model');
tsdefine('APP_WIDGET_PATH'	, APP_PATH.'/Widget');
...
tsdefine('THEME_PUBLIC_PATH', THEME_PATH.'/_stastic');
tsdefine('THEME_PUBLIC_URL'	, THEME_URL.'/_stastic');
tsdefine('APP_PUBLIC_URL'	, THEME_PUBLIC_URL.'/'.TRUE_APPNAME);
tsdefine('APP_TPL_PATH'		, THEME_PATH.'/'.TRUE_APPNAME);

...
return  array(
	...
	'DEFAULT_APPS'			=>	array('public','admin','home','club','people'),	//默认核心应用
	'SITE_LOGO'				=>  'image/logo.gif', //默认的站点logo
    ...
    'COOKIE_PREFIX'         =>	'SOCIAX_',		// Cookie前缀 避免冲突
    ...
    'SESSION_NAME'          => 'TSSESSION',      // Session名称

...
{//类定义开始
	...
	private function initSite() {
        ...
        //网站根目录
        $this->assign('site_top_nav',model('Navi')->getTopNav());
        $this->assign('site_bottom_nav',model('Navi')->getBottomNav());
        return;
	}
    ...
    private function initApp() {
        ...
        $appId = model('App')->getAppIdByName(APP_NAME);
        
        $this->app = model('App')->getAppById($appId);

...
class MailModel {
	...
	public function __construct() {
		tsload(ADDON_PATH.'/liberary/phpmailer/class.phpmailer.php');
		tsload(ADDON_PATH.'/liberary/phpmailer/class.pop3.php');
		tsload(ADDON_PATH.'/liberary/phpmailer/class.smtp.php');

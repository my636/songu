...
class CommentModel extends Model {
	...
	protected $fields = array('comment_id','app','table','row_id','app_uid','uid','content','to_comment_id','to_uid','data','ctime','is_del','client_type');
     ...
     */
    public function deleteComment($ids, $uid = null) {

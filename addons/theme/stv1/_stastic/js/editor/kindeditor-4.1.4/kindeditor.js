...
K.options = {
	...
	htmlTags : {
		...
		img : ['id', 'class', 'src', 'width', 'height', 'border', 'alt', 'title', 'align', 'style', '.width', '.height', '.border']
	},
	// htmlTags : {
...
_extend(KCmd, {
	...
	insertimage : function(url, title, width, height, border, align) {
		...
		var html = '<img src="' + _escape(url) + '" data-ke-src="' + _escape(url) + '" style="display:block;margin:5px,0;"';
		if (width) {
...
KISSY.Editor = function(id , mode , focusset){
	...
	modeitem['photo']   = [ 'bold', 'italic', 'underline',  'forecolor','removeformat', 'image'];

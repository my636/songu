...
function _getBasePath() {
	...
	return THEME_URL+'/js/editor/kindeditor-4.1.1/';
...
K.options = {
	...
	// ],
	items : [
		'forecolor', 'bold', 'italic', 'underline', 'strikethrough', 'image', 'emoticons', 'link'
	],
...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	var arr = [
		...
		'body, td {font:14px/1.5 "sans serif",tahoma,verdana,helvetica;}',   //2012.11.8修改

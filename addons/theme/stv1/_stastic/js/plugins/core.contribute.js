...
core.contribute = {
	 ...
	 * @return void
	 */
	init: function(textarea, callback)
	{
	...
	insertTemplates: function()
	{
		...
		if(!this.isExistBox()) {
			$.post(U('channel/Index/getCategoryData'), {}, function(msg) {
				if(msg.status == 1) {
					var offsetVal = _this.textarea.offset();
					var html = '';
					html += '<div id="contribute_templates" class="talkPop alL" style="top:'+(offsetVal.top+78)+'px;left:'+(offsetVal.left+260)+'px;z-index:9999;*padding:20px 0 0 40px;">\
							 <div class="wrap-layer">\
							 <div class="arrow arrow-t"></div>\
							 <div class="talkPop_box">\
							 <div class="close hd"><a title="关闭" href="javascript:;" onclick="core.contribute.closeBox()" class="ico-close">&nbsp;</a></div>\

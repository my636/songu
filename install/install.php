...
<?php
	...
	$sql1 = "INSERT INTO `{$db_config['db_prefix']}user` VALUES (".$admin_id.", '".$siteFounder['email']."', '".$siteFounder['password']."', '11111', '管理员', '".$siteFounder['email']."', '1', '北京市 北京市 海淀区', '1', '1', '1', ".time().", '1', null, '', '110000', '110100', '110108', '127.0.0.1', 'zh-cn', 'PRC', '0', 'G', '', null, null, null, '管理员 guanliyuan', null);";
